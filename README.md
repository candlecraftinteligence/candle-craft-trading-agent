...
- Console output starts with a scanner dashboard and classifies each symbol as `🟢 VALID SETUP`, `🟡 NEAR MISS`, `🔴 NO SETUP`, or `⚪ DATA INCOMPLETE`.
