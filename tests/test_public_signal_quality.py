...
def test_public_quality_rank_supports_full_grade_ladder() -> None:
    ...
    assert MIN_PUBLIC_SIGNAL_GRADE == "B+"
...
def test_grade_b_plus_and_a_family_pass_min_public_signal_grade() -> None:
    for grade in ("B+", "A-", "A", "A+"):
...
def test_numeric_only_scores_map_to_public_grade_ranks() -> None:
    ...
    assert public_quality_decision(score_candidates=(75,)).passed is True
